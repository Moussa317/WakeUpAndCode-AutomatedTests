...
namespace ReadingLog.Data
{
    ...
    public class UnitOfWork<TContext> : IUnitOfWork where TContext : DbContext
    {
        ...
        /// <inheritdoc/>
        public ValueTask<EntityEntry<T>> AddAsync<T>(T entity) where T : class, IBaseEntity => _context.AddAsync(entity);
        ...
        /// <inheritdoc/>
        public virtual void DeleteRange<T>(IEnumerable<T> entities) where T : class, IBaseEntity => _context.RemoveRange(entities);
